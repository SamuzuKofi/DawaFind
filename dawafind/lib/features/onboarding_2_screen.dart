...
class Onboarding2Screen extends StatelessWidget {
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _languageRow(AppStrings.english, selected: true),
            _languageRow(AppStrings.french, selected: false),
            _languageRow(AppStrings.kirundi, selected: false),
          ],
        ),
      ),
    );
  ...
  Widget _languageRow(String label, {required bool selected}) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          if (selected) const Icon(Icons.check, color: AppColors.primaryGreen, size: 18),
        ],
      ),
    );
  }
