...
class _MedicineSearchScreenState extends State<MedicineSearchScreen> {
  ...
  final _results = [
    {'drug': 'Amoxicillin 500mg', 'pharmacy': 'Dawa Pharmacy', 'price': 'RWF 2,300', 'available': true},
    {'drug': 'Amoxicillin 250mg', 'pharmacy': 'Health Plus Pharmacy', 'price': 'RWF 1,800', 'available': true},
    {'drug': 'Amoxicillin 125mg', 'pharmacy': 'City Pharma', 'price': 'RWF 1,500', 'available': false},
  ];
  ...
  Widget _emptyState() => const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text('Type a drug name to search',
        ...
        itemBuilder: (context, i) {
          if (i == _results.length) {
            return TextButton.icon(
              ...
              label: const Text("Can't find your medicine?",
          ...
          return Card(
            ...
            child: ListTile(
              ...
              title: Text(r['drug'] as String,
                  style: const TextStyle(
                      fontWeight: FontWeight.bold,
                      color: AppColors.darkText)),
              subtitle: Text(r['pharmacy'] as String,
                  style: const TextStyle(
